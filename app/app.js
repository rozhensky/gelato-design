...
"На Aura зібрані різні дизайн-системи продуктів. Знайдіть ту, що подобається найбільше, відкрийте її, скопіюйте посилання — і вставте нижче. Це допоможе нам зрозуміти ваші смаки.":"На Aura собраны разные дизайн-системы продуктов. Найдите ту, что нравится больше всего, откройте её, скопируйте ссылку — и вставьте ниже. Это поможет нам понять ваши вкусы."
    ...
    var EN = {"Опис продукту":"Product overview","Запис не підтримується — завантажте аудіофайл":"Recording isn't supported — upload an audio file","Немає доступу до мікрофона":"No microphone access","Запис надто короткий":"Recording too short","Натисніть, щоб записати голосову":"Tap to record a voice note","● Запис…":"● Recording…","Аудіо недоступне":"Audio unavailable","Не вдалося відтворити":"Couldn't play","Перевірте посилання":"Check the link","Бриф":"Brief","Інтерактивний бриф · ~10–15 хв":"Interactive brief · ~10–15 min","Розкажіть про ідею":"Tell us about your idea","10 коротких питань, щоб ми зрозуміли ваш продукт ще до стратегічної сесії. Відповідайте, як зручно — голосом, посиланнями чи відео.":"10 short questions so we understand your product before the strategy session. Answer however suits you — by voice, links, or video.","Голосом":"By voice","На кожне питання — одна чи кілька голосових. Можна прослухати й перезаписати.":"One or more voice notes per question. You can listen back and re-record.","Посилання та відео":"Links and video","Кидайте конкурентів, референси, огляди чи Loom — усе в одному місці.":"Drop in competitors, references, reviews, or a Loom — all in one place.","Зберігається саме":"Saved automatically","Можна вийти й повернутись будь-коли — відповіді лишаться на вашому акаунті.":"Leave and come back anytime — your answers stay on your account.","Огляд":"Review","Продовжити · {0}/10":"Continue · {0}/10","Розпочати":"Start","Контакти":"Contacts","Перед початком":"Before you begin","Ваші контакти":"Your contacts","Лишіть контакти, щоб ми могли звʼязатися щодо стратегічної сесії.":"Leave your contacts so we can reach out about the strategy session.","Імʼя":"Name","Як до вас звертатися":"What should we call you","Телефон":"Phone","номер телефону":"phone number","Соцмережі":"Social media","напишіть нік":"enter your handle","Обовʼязково: імʼя, email і телефон. Соцмережі — за бажанням.":"Required: name, email, and phone. Social media is optional.","Перейти до питань":"Go to questions","Вкажіть імʼя":"Enter your name","Вкажіть коректний email":"Enter a valid email","Вкажіть номер телефону":"Enter your phone number","Не вдалося зберегти контакти — перевірте бекенд":"Couldn't save contacts — check the backend","Запис #{0}":"Recording #{0}","Почнімо з головного":"Let's start with the basics","Розкажіть про продукт своїми словами":"Tell us about your product in your own words","Перед детальними питаннями просто опишіть голосом, про що ваш продукт і навіщо ви його робите — як відчуваєте самі, без деталізації. Можна одне чи кілька повідомлень, будь-якої довжини. Далі перейдемо до конкретних питань.":"Before the detailed questions, just describe by voice what your product is and why you're building it — how it feels to you, no specifics. One message or several, any length. Then we'll move on to the specific questions.","Голосовий опис":"Voice description","До питань":"To the questions","Посилання":"Link","Вставте посилання":"Paste a link","Додати":"Add","Питання {0} з {1}":"Question {0} of {1}","Питання":"Question","Голосова відповідь":"Voice answer","До огляду":"To review","Далі":"Next","Ще не заповнено":"Not filled in yet","Бриф надіслано":"Brief submitted","Дякуємо! Будь-які зміни, які ви додаєте далі — нові голосові чи посилання — ми отримуємо автоматично. Повторно надсилати нічого не потрібно.":"Thank you! Any changes you add later — new voice notes or links — reach us automatically. There's no need to submit again.","Майже готово":"Almost done","Перегляньте бриф":"Review your brief","Усе заповнено — можна надсилати бриф.":"Everything's filled in — you can submit the brief.","Заповнено {0} із {1}. Надіслати можна, коли заповните всі питання.":"Completed {0} of {1}. You can submit once all questions are filled.","Огляд · {0}/{1}":"Review · {0}/{1}","Надіслати бриф":"Submit brief","Дякуємо за підтвердження! Ми вивчимо матеріали й підготуємось до стратегічної сесії. Будь-які зміни, які ви додасте далі, ми отримаємо автоматично — повторно надсилати не потрібно.":"Thank you for confirming! We'll go through the materials and prepare for the strategy session. Any changes you add later reach us automatically — no need to submit again.","Відкрити бриф знову":"Open the brief again","Завантаження брифу…":"Loading brief…","Бриф не завантажився — перевірте функцію save":"The brief didn't load — check the save function","Проблема та її актуальність":"The problem and why it matters","Для кого це":"Who it's for","Як вирішують зараз":"How it's solved today","Суть і головна цінність":"Core idea and main value","Перший «вау»-сценарій":"First \"wow\" moment","Функції першої версії":"First version features","Референси та конкуренти":"References and competitors","Бренд, тон і стиль":"Brand, tone, and style","Монетизація":"Monetization","Успіх і наступний крок":"Success and next step","Яку проблему вирішує ваш продукт і чому вона важлива? Що зараз незручно, повільно або дорого для ваших користувачів? Наприклад: «люди витрачають години на пошук…» або «бізнес втрачає клієнтів, бо…».":"What problem does your product solve and why does it matter? What's inconvenient, slow, or expensive for your users right now? For example: \"people spend hours searching for…\" or \"businesses lose customers because…\".","Хто ваш головний користувач? Опишіть конкретну людину: вік, рід занять, ситуація. Коли й де вона скористається продуктом? Наприклад: «підприємець-початківець, який щойно відкрив магазин».":"Who is your main user? Describe a specific person: age, occupation, situation. When and where would they use the product? For example: \"a first-time entrepreneur who just opened a shop\".","Як люди вирішують це завдання зараз — інші додатки, Excel, вручну чи ніяк? Що в цих способах не влаштовує і чим ви будете кращими? Додайте посилання на конкурентів, якщо є.":"How do people handle this task today — other apps, Excel, by hand, or not at all? What's wrong with those ways, and how will you be better? Add links to competitors if you have any.","Опишіть продукт простими словами, ніби розповідаєте другу. Що людина зможе зробити і що отримає в результаті? Наприклад: «застосунок, де за 2 хвилини можна…».":"Describe the product in simple words, as if telling a friend. What can a person do, and what do they get out of it? For example: \"an app where in 2 minutes you can…\".","Уявіть, що людина вперше відкрила продукт. Проведіть нас кроками: що вона бачить, що натискає і в який момент думає «о, це справді корисно»?":"Imagine someone opens the product for the first time. Walk us through the steps: what they see, what they tap, and the moment they think \"oh, this is genuinely useful\"?","Які 3–5 функцій обовʼязкові для першої версії — без них продукт не має сенсу? І що навпаки можна сміливо відкласти на потім?":"Which 3–5 features are essential for the first version — the ones without which the product makes no sense? And which can safely wait for later?","Покажіть продукти, додатки чи сайти, які вам подобаються — і скажіть, що саме чіпляє (зручність, стиль, конкретна функція). Додайте посилання, відео-огляди або запис екрана.":"Show us products, apps, or sites you like — and tell us what exactly grabs you (usability, style, a specific feature). Add links, video reviews, or a screen recording.","Який характер і настрій у продукту — діловий, дружній, преміальний, грайливий? Які кольори чи візуал вам близькі? Запишіть голосом свої побажання до дизайну й обовʼязково додайте посилання на референси.":"What's the product's character and mood — businesslike, friendly, premium, playful? What colors or visuals feel right to you? Record your design wishes by voice and be sure to add links to references.","Як продукт заробляє або зароблятиме — підписка, разова оплата, комісія, реклама? Хто і скільки приблизно платить? Якщо ще не вирішили — опишіть варіанти, які розглядаєте.":"How does the product make money, or how will it — subscription, one-time payment, commission, ads? Who pays, and roughly how much? If you haven't decided yet, describe the options you're considering.","Як ви зрозумієте, що прототип вдалий — які цифри чи реакція людей це покажуть? Кому плануєте показати першим: інвесторам, аудиторії чи першим клієнтам?":"How will you know the prototype is a success — what numbers or people's reactions will show it? Who do you plan to show it to first: investors, your audience, or first customers?","Якщо є дослідження, статті чи дані, що підтверджують проблему — додайте посилання.":"If you have research, articles, or data backing up the problem — add a link.","Якщо ви вже описали цільову аудиторію (портрет користувача, дослідження) — додайте посилання на документ.":"If you've already described your target audience (user persona, research) — add a link to the document.","Посилання на конкурентів або рішення, якими люди користуються зараз.":"Links to competitors or solutions people use today.","Якщо є презентація, лендинг чи опис продукту — додайте посилання.":"If you have a deck, landing page, or product description — add a link.","Якщо є приклад подібного флоу, демо чи запис екрана — додайте посилання.":"If you have an example of a similar flow, a demo, or a screen recording — add a link.","Якщо є список функцій, бек-лог чи roadmap — додайте посилання.":"If you have a feature list, backlog, or roadmap — add a link.","Посилання на продукти/інтерфейси, що подобаються, відео-огляди або Loom.":"Links to products/interfaces you like, video reviews, or a Loom.","Референси дизайну, мудборд, бренд-гайд або посилання з Aura.":"Design references, a moodboard, a brand guide, or links from Aura.","Якщо є фінмодель, прайсинг чи приклади монетизації — додайте посилання.":"If you have a financial model, pricing, or monetization examples — add a link.","Якщо є метрики, цілі чи матеріали для інвесторів — додайте посилання.":"If you have metrics, goals, or materials for investors — add a link.","Відкрити Aura":"Open Aura","Голос":"Voice","Відео":"Video","На Aura зібрані різні дизайн-системи продуктів. Знайдіть ту, що подобається найбільше, відкрийте її, скопіюйте посилання — і вставте нижче. Це допоможе нам зрозуміти ваші смаки.":"Aura gathers various product design systems. Find the one you like most, open it, copy the link — and paste it below. This helps us understand your taste."};
    var DICTS = { ru: RU, en: EN };
    function t(s) { var d = DICTS[LANG]; return (d && d[s] != null) ? d[s] : s; }
    function tf(s) { var a = arguments; return t(s).replace(/\{(\d+)\}/g, function (_, i) { return a[(+i) + 1]; }); }
    var PLURALS = {
        'запис': { uk: ['запис', 'записи', 'записів'], ru: ['запись', 'записи', 'записей'], en: ['recording', 'recordings'] },
        'посилання': { uk: ['посилання', 'посилання', 'посилань'], ru: ['ссылка', 'ссылки', 'ссылок'], en: ['link', 'links'] }
    };
    function pl(n, key) { var f = (PLURALS[key] && PLURALS[key][LANG]) || PLURALS[key].uk; if (LANG === 'en') return n === 1 ? f[0] : f[1]; var d = n % 10, h = n % 100; if (d === 1 && h !== 11) return f[0]; if (d >= 2 && d <= 4 && (h < 12 || h > 14)) return f[1]; return f[2]; }
        ...
        return '' +
            '<div class="top">' +
                ...
                '<div class="lang-toggle">' +
                    ...
                    '<button type="button" data-lang="en"' + (LANG === 'en' ? ' class="on"' : '') + '>EN</button>' +
                '</div>' +
            '</div>' +
